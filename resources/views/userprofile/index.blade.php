            ...
            <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <a href="/metronic8/demo50/../demo50/apps/ecommerce/catalog/add-category.html" class="btn btn-light-primary btn-sm mb-10"> <i class="ki-outline ki-plus fs-2"></i> Create new category </a>
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="fv-row mb-10">
                                        <label class="fs-6 fw-semibold mb-2">
                                            ...
                                            <span class="ms-1" data-bs-toggle="tooltip" title="Select a discount type that will be applied to this product"> <i class="ki-outline ki-information-5 text-gray-500 fs-6"></i></span>
                                        </label>
                                    ...
                                    <div class="" data-kt-ecommerce-catalog-add-product="auto-options">
                                        ...
                                        <div id="kt_ecommerce_add_product_options">
                                            ...
                                            <div class="form-group mt-5">
                                                <button type="button" data-repeater-create class="btn btn-sm btn-light-primary"><i class="ki-outline ki-plus fs-2"></i> Add another variation</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
